...
function adaptive_header(w,h) {
	...
	if(w<768){
		...
		$.each($('.header-body__nav'), function(index, val) {
			if($(this).hasClass('header-body__nav--right')){
...
$('.header-body__mob-menu-icon').click(function(event) {
	$(this).toggleClass('active');
	$('.header-body__mob-menu').toggleClass('active');
	if($(this).hasClass('active')){
